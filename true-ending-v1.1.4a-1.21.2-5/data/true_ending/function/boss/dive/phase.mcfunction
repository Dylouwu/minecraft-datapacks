...
execute as @n[type=marker,tag=trueEnding_pivot] at @s run tp @s ~ ~ ~ ~ ~1.5
execute if score @s trueEnding_bosstime matches 961 as @n[type=marker,tag=trueEnding_pivot] at @s run tp @s ~ ~ ~ ~ ~-90
...
execute if score @s trueEnding_bosstime matches 960..1020 positioned 0 90 0 positioned over motion_blocking positioned ~ ~-6 ~ rotated as @n[type=marker,tag=trueEnding_pivot] run function true_ending:boss/dive/circle_ring_warn
